...
function Page(): JSX.Element {
  ...
  const handleForm = async (event: { preventDefault: () => void }) => {
    ...
    const { result, authError } = await signUp(email, password);
    ...
    <section className="text-gray-600 ">
      ...
      <form onSubmit={handleForm} className="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
          <h1 className="title-font font-medium text-3xl text-gray-900">These notes are like a map that shows the way to do well in school.</h1>
          <p className="leading-relaxed mt-4">This is why, whether you're a student or a teacher, creating an account is essential to add value to the community.</p>
        </div>
            ...
            <fieldset>
              <div className="mt-6 space-y-6">
                ...
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    <label htmlFor="student" className="font-medium text-gray-900">
                      Student
                    </label>
